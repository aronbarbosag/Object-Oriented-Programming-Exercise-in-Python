...
class Calculator1:
    ...
    * A primeira parte é dividida por 4 e seu resultado somado a 7.Após
    isso, o resultado é elevado ao quadrado e multiplicado por um valor de 0.257.
    
    *A segunda parte é elevada a potencia de 2.121, dividida por 5 e somado a 1
    ...
    *A terceira parte se mantem no mesmo valor.
    ...
    def calculate(self,request: FlaskRequest) -> Dict:
        ...
        first_process_result = self.__firt_process(splited_number)
    ...
    def __firt_process(self, first_number:float) -> float:
